# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2020-06-15 13:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sale.Campuses', verbose_name='校区')),
                ('teachers', models.ManyToManyField(to='sale.UserInfo', verbose_name='老师')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, to='sale.ClassList', verbose_name='已报班级')),
                ('consultant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='sale.UserInfo', verbose_name='销售')),
                ('introduce_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sale.Customer', verbose_name='转介绍自学员')),
            ],
            options={
                'verbose_name': '客户信息表',
