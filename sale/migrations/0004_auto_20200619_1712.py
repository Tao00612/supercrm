# -*- coding: utf-8 -*-
# Generated by Django 1.11.9 on 2020-06-19 09:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('re_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sale.ClassList', verbose_name='班级')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sale.UserInfo', verbose_name='讲师')),
            ],
        ),
        migrations.CreateModel(
            name='StudyRecord',
            fields=[
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sale.CourseRecord', verbose_name='某节课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sale.Customer', verbose_name='学员')),
            ],
        ),
